        ...
        >
          <div className="overflow-hidden rounded-2xl border border-red-500/30 bg-slate-900/95 shadow-2xl shadow-red-950/50 backdrop-blur">
            ...
            <div className="p-8">
              ...
              <div className="mt-4 rounded-xl border-2 border-red-500/50 bg-red-950/40 px-4 py-3">
                <p className="text-center text-sm font-semibold text-red-300">
                  Access Denied: 3+ unique devices detected in under 10 minutes. Account locked for security.
                </p>
              </div>
              <p className="mt-4 text-center text-sm leading-relaxed text-slate-400">
                Our system detected more than 3 distinct devices (IP + browser + OS)
                accessing your account within 10 minutes. This may indicate account
                compromise or fraudulent behavior. Access is temporarily restricted.
              </p>
